...
public class DBConn
{
	...
	public static Connection getConnection()
	{
		...
		{ 
			try
			{
				String url = "jdbc:oracle:thin:@211.238.142.159:1521:xe"; 		//-- thin 드라이브 url 포맷
				//-- 『211.238.142.150』는 오라클 서버 ip 주소를 기재하는 부분
				...
				//   Class 안의 forName 메소드는 매개변수로 넘겨주는 값을 이름으로 가진 객체를 찾음 
